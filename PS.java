...
public class PS {
    ...
    /*public PS(String path, String path2) {
    ...
    public void transformacjaLiniowa(int b) {
        for (int x = 0; x < width; x++) {
            for (int y = 0; y < height; y++) {
                ...
                if (red + b >= 0 && red + b <= 255) red = red + b;
                if (green + b >= 0 && green + b <= 255) green = green + b;
                if (blue + b >= 0 && blue + b <= 255) blue = blue + b;
                Color newColor = new Color(red, green, blue);
                image.setRGB(x, y, newColor.getRGB());
            }
        }
    ...
    public void mieszanieSuma() {
        for (int x = 0; x < width; x++) {
            for (int y = 0; y < height; y++) {
                ...
                if (red + red2 >= 0 && red + red2 <= 255) red = red + red2;
                if (green + green2 >= 0 && green + green2 <= 255) green = green + green2;
                if (blue + blue2 >= 0 && blue + blue2 <= 255) blue = blue + blue2;
                Color newColor = new Color(red, green, blue);
                image.setRGB(x, y, newColor.getRGB());
            }
        }
    ...
    public void mieszanieOdejmowanie() {
        for (int x = 0; x < width; x++) {
            for (int y = 0; y < height; y++) {
                ...
                int green2 = b.getGreen();
                int blue2 = b.getBlue();
                if (red + red2 - 1 >= 0 && red + red2 <= 255) red = red + red2 - 1;
                if (green + green2 - 1 >= 0 && green + green2 <= 255) green = green + green2 - 1;
                if (blue + blue2 - 1 >= 0 && blue + blue2 <= 255) blue = blue + blue2 - 1;
                Color newColor = new Color(red, green, blue);
                image.setRGB(x, y, newColor.getRGB());
            }
        }
    ...
    public void mieszanieMnozenie() {
        for (int x = 0; x < width; x++) {
            for (int y = 0; y < height; y++) {
                ...
                if (red / 255 * red2 / 255 >= 0 && red / 255 * red2 / 255 <= 255)
                    red = ((red / 255) * (red2 / 255)) * 255;
                if (green / 255 * green2 / 255 >= 0 && green / 255 * green2 / 255 <= 255)
                    green = ((green / 255) * (green2 / 255)) * 255;
                if (blue / 255 * blue2 / 255 >= 0 && blue / 255 * blue2 / 255 <= 255)
    ...
    public void mieszanieRozceinczenie() {
        for (int x = 0; x < width; x++) {
            for (int y = 0; y < height; y++) {
                ...
                if (((red / 255) / (1 - (red2 / 255))) * 255 >= 0 && ((red / 255) / (1 - (red2 / 255))) * 255 <= 255)
                    red = ((red / 255) / (1 - (red2 / 255))) * 255;
                if (((green / 255) / (1 - (green2 / 255))) * 255 >= 0 && ((green / 255) / (1 - (green2 / 255))) * 255 <= 255)
                    green = ((green / 255) / (1 - (green2 / 255))) * 255;
                if (((blue / 255) / (1 - (blue2 / 255))) * 255 >= 0 && ((blue / 255) / (1 - (blue2 / 255))) * 255 <= 255)
    ...
    public void mieszanieWypalenie() {
        for (int x = 0; x < width; x++) {
            for (int y = 0; y < height; y++) {
                ...
                if ((1 - (1 - (red / 255)) / (red2 / 255)) * 255 >= 0 && (1 - (1 - (red / 255)) / (red2 / 255)) * 255 <= 255)
                    red = (1 - (1 - (red / 255)) / (red2 / 255)) * 255;
                if ((1 - (1 - (green / 255)) / (green2 / 255)) * 255 >= 0 && (1 - (1 - (green / 255)) / (green2 / 255)) * 255 <= 255)
                    green = (1 - (1 - (green / 255)) / (green2 / 255)) * 255;
                if ((1 - (1 - (blue / 255)) / (blue2 / 255)) * 255 >= 0 && (1 - (1 - (blue / 255)) / (blue2 / 255)) * 255 <= 255)
